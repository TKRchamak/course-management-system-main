...
<body>
        ...
        <nav>
            <ul class="nav nav-pills justify-content-evenly d-flex ">
                ...
                <li class="nav-item  dropdown">
                    <a class="nav-link dropdown-toggle active" href="http://localhost/course-management-system-main/student_info.php#" id="navbarScrollingDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        Student Information
                    </a>
  ...
  <section class="container">
    <div class="row" id="Personal">
      <h2 class="text-center bg-light">Personal Information</h2>
    ...
    <div class="row" id="Institutional">
      <h2 class="text-center bg-light">Institutional Information</h2>
      <table class="table table-bordered border-primary">
        <thead>
          <tr>
            <th scope="col">Data</th>
